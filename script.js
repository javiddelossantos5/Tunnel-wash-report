function calculate() {
  ...
  const receiptFromTill11 = document.getElementById('receiptFromTill11').value * 11;
  const receiptFromTill14 = document.getElementById('receiptFromTill14').value * 14;
  const receiptFromTill16 = document.getElementById('receiptFromTill16').value * 16;
  ...
  receiptFromTillTotal = Number(receiptFromTill11) + Number(receiptFromTill14) + Number(receiptFromTill16);
  ...
  noCharge = Number(testWashTotal) + Number(receiptFromTillTotal) + Number(reWashTotal) + Number(employeeTotal) + Number(refundTotal);
